...
Отлично! Я подготовлю расширенное дополнение к лекции по Docker, включив подробности о слоях образов (read-only, read-write, overlayFS), устройстве томов и временных хранилищ, типах сетей (bridge, host, overlay), DNS и IP, политике рестартов, работе с логами и exec, различиях между томами и bind-монтами, а также внутреннее устройство хранения данных в контейнере.

Оформлю всё это в виде расширенного Markdown-документа, подходящего для GitHub. Скоро вернусь с обновлением!
